...
namespace MyAutoClicker
{
    public class MainForm : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            btnHelp.MouseEnter += (s, e) => btnHelp.BackColor = Color.FromArgb(42, 42, 42);
            btnHelp.MouseLeave += (s, e) => btnHelp.BackColor = Color.FromArgb(25, 25, 25);
            ...
            UIHelper.ApplyModernStyle(btnPickTarget);
            ...
            UIHelper.ApplyModernStyle(btnStart);
            ...
            UIHelper.ApplyModernStyle(btnStop);
            ...
            UIHelper.ApplyModernStyle(btnHotkeys);
            ...
            UIHelper.ApplyModernStyle(btnSaveSettings);
            ...
            UIHelper.ApplyModernStyle(btnResetSettings);
        ...
        private void ShowHotkeyDialog()
        {
            using (Form dialog = new Form())
            {
                ...
                UIHelper.ApplyModernStyle(btnSave);
                UIHelper.ApplyModernStyle(btnCancel);
